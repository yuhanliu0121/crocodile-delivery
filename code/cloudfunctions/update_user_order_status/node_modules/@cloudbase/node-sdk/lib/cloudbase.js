...
class CloudBase {
    ...
    static getCloudbaseContext(context) {
        ...
        rawContext = Object.assign(Object.assign({}, rawContext), contextEnv);
        let finalContext = {};
    ...
    init(config = {}) {
        ...
        const newConfig = Object.assign(Object.assign({}, restConfig), { debug: !!debug, secretId: secretId, secretKey: secretKey, sessionToken: sessionToken, envName: env, headers: Object.assign({}, headers), timeout: timeout || 15000, throwOnCode: throwOnCode !== undefined ? throwOnCode : true });
