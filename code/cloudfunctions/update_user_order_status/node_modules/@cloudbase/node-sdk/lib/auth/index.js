    ...
    return {
        ...
        getEndUserInfo(uid, opts) {
            ...
            return httpRequest_1.default({
                ...
                return {
                    userInfo: Object.assign(Object.assign({}, defaultUserInfo), res.data),
        ...
        createTicket: (uid, options = {}) => {
            ...
            if (!envName) {
                throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: 'no env in config' }));
            }
            // 检查credentials 是否包含env
            if (!env_id) {
                throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: '当前私钥未包含env_id 信息， 请前往腾讯云云开发控制台，获取自定义登录最新私钥' }));
            }
            ...
            if (env_id && env_id !== envName) {
                throw utils_1.E(Object.assign(Object.assign({}, code_1.ERROR.INVALID_PARAM), { message: '当前私钥所属环境与 init 指定环境不一致！' }));
            }
